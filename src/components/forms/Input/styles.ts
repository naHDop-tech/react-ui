...
export const StyledLabel = styled.div<ITextInputProps>`
   font-size: 14px;
   color: ${props => props.disabled ? "#e4e3ea" : "#080808"};
   padding-bottom: 6px;
`;

export const StyledMessage = styled.div<ITextInputProps>`
   font-size: 14px;
   color: #a9150b8;
   padding-top: 4px;
`;

export const StyledText = styled.p<ITextInputProps>`
   margin: 0px;
